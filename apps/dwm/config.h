...
static const Key keys[] = {
  ...
  { MODKEY,                       XK_t,      spawn,          {.v = launchercmd} },
	{ MODKEY,                       XK_r,      spawn,          {.v = dmenucmd } },
	{ MODKEY,                       XK_Return, spawn,          {.v = termcmd } },
  { MODKEY,                       XK_b,                      spawn,          SHCMD ("xdg-open https://")},
  { MODKEY,                       XK_p,                      spawn,          SHCMD ("flameshot full -p ~/Pictures/")},
  { MODKEY|ShiftMask,             XK_p,                      spawn,          SHCMD ("flameshot gui -p ~/Pictures/")},
  { MODKEY|ControlMask,           XK_p,                      spawn,          SHCMD ("flameshot gui --clipboard")},
  { MODKEY,                       XK_e,                      spawn,          SHCMD ("xdg-open .")},
  { MODKEY,                       XK_w,                      spawn,          SHCMD ("looking-glass-client -F")},
  { MODKEY|ShiftMask,             XK_w,                      spawn,          SHCMD ("feh --randomize --bg-fill ~/wallpaper/*")},
