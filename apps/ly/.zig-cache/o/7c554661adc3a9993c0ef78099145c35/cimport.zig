...
pub const struct___exit_status = extern struct {
    __e_termination: c_short = @import("std").mem.zeroes(c_short),
    __e_exit: c_short = @import("std").mem.zeroes(c_short),
};
const struct_unnamed_1 = extern struct {
    tv_sec: __uint32_t = @import("std").mem.zeroes(__uint32_t),
    tv_usec: __int32_t = @import("std").mem.zeroes(__int32_t),
};
pub const struct_utmpx = extern struct {
    ut_type: c_short = @import("std").mem.zeroes(c_short),
    ut_pid: __pid_t = @import("std").mem.zeroes(__pid_t),
    ut_line: [32]u8 = @import("std").mem.zeroes([32]u8),
    ut_id: [4]u8 = @import("std").mem.zeroes([4]u8),
    ut_user: [32]u8 = @import("std").mem.zeroes([32]u8),
    ut_host: [256]u8 = @import("std").mem.zeroes([256]u8),
    ut_exit: struct___exit_status = @import("std").mem.zeroes(struct___exit_status),
    ut_session: __int32_t = @import("std").mem.zeroes(__int32_t),
    ut_tv: struct_unnamed_1 = @import("std").mem.zeroes(struct_unnamed_1),
    ut_addr_v6: [4]__int32_t = @import("std").mem.zeroes([4]__int32_t),
    __glibc_reserved: [20]u8 = @import("std").mem.zeroes([20]u8),
};
pub extern fn setutxent() void;
pub extern fn endutxent() void;
pub extern fn getutxent() [*c]struct_utmpx;
pub extern fn getutxid(__id: [*c]const struct_utmpx) [*c]struct_utmpx;
pub extern fn getutxline(__line: [*c]const struct_utmpx) [*c]struct_utmpx;
pub extern fn pututxline(__utmpx: [*c]const struct_utmpx) [*c]struct_utmpx;
...
pub const __UT_LINESIZE = @as(c_int, 32);
pub const __UT_NAMESIZE = @as(c_int, 32);
pub const __UT_HOSTSIZE = @as(c_int, 256);
pub const EMPTY = @as(c_int, 0);
pub const BOOT_TIME = @as(c_int, 2);
pub const NEW_TIME = @as(c_int, 3);
pub const OLD_TIME = @as(c_int, 4);
pub const INIT_PROCESS = @as(c_int, 5);
pub const LOGIN_PROCESS = @as(c_int, 6);
pub const USER_PROCESS = @as(c_int, 7);
pub const DEAD_PROCESS = @as(c_int, 8);
...
pub const __exit_status = struct___exit_status;
pub const utmpx = struct_utmpx;
