...
pub extern fn fgetgrent(__stream: ?*FILE) [*c]struct_group;
...
pub extern fn fgetgrent_r(noalias __stream: ?*FILE, noalias __resultbuf: [*c]struct_group, noalias __buffer: [*c]u8, __buflen: usize, noalias __result: [*c][*c]struct_group) c_int;
